...
public class AutonomousGrabberConveyorCmd extends Command {
  ...
  public AutonomousGrabberConveyorCmd(GrabberSubsystem grabberSubsystem, double grabberTargetSpeed, ConveyorSubsystem conveyorSubsystem, double conveyorTargetSpeed, ProximitySensorSubsystem proximitySensorSubsystem, double durationSeconds) {
