...
public final class Constants {
  ...
  public static final class Swerve {
    ...
    public static final class Mod0 {
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(354.02);
    ...
    public static final class Mod2 {
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(187.82);
      public static final SwerveModuleConstants constants =
          new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
    }
  ...
  public static final class Mechanisms {
    ...
    public static final double grabberTargetSpeed = 0.40;  // 0.25
    public static final double conveyorTargetSpeed = 0.40; // 0.25
