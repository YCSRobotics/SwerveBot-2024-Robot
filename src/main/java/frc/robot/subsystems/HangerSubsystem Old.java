...
public class HangerSubsystem extends SubsystemBase {
    ...
    public void setHangerPositionTarget(double targetPosition) {
        m_leftHangerMotor.getPIDController().setReference(targetPosition, ControlType.kVelocity);
        m_rightHangerMotor.getPIDController().setReference(targetPosition, ControlType.kVelocity);
    }
