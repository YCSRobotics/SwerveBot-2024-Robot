...
public class DriveSeven extends SequentialCommandGroup {
  public DriveSeven(Swerve s_Swerve, LauncherSubsystem launcherSubsystem, ConveyorSubsystem conveyorSubsystem) {
    ...
    Trajectory exampleTrajectory =
        TrajectoryGenerator.generateTrajectory(
            ...
            new Pose2d(2.13, 0, new Rotation2d(0)),
            config);
