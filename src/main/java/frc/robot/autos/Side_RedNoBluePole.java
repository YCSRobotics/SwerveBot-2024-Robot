...
public class Side_RedNoBluePole extends SequentialCommandGroup {
  public Side_RedNoBluePole(Swerve s_Swerve, LauncherSubsystem launcherSubsystem, GrabberSubsystem grabberSubsystem, ConveyorSubsystem conveyorSubsystem, ProximitySensorSubsystem proximitySensorSubsystem) {
    ...
    Trajectory forwardCenterTrajectory =
        TrajectoryGenerator.generateTrajectory(
            ...
            new Pose2d(1.9, -0.1, new Rotation2d(-Math.PI / 8)), // 13
            config);
